...
- Still deferred (named in the port spec): the full remote method catalog (session follow/control streams, settings/credentials/workspace/directoryPicker namespaces, SessionWireEvent projection), the Roslyn source generator for typed codecs, the ui-* plugin set, locale dictionaries, and the trust/auth fence beyond loopback.
