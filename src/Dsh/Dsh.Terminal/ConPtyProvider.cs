...
/// under a controlled prompt (<c>ESC ] 133;D; ESC \ dsh&gt; </c>) so sends settle on prompt
...
internal sealed class ConPtyChild : IDisposable
{
    ...
    private void SpawnCore(ConPtyConfig config, string? requestCwd)
    {
        ...
        // The controlled prompt through cmd's PROMPT metavariable: ESC ] 133;D; ESC \ dsh> .
        var prompt = "\u001b]133;D;\u001b\\dsh$G ";
        ...
        var envBlock = BuildEnvironmentBlock("\u001b]133;D;\u001b\\dsh$G ");
