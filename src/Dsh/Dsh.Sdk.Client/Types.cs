...
public class HarnessClientOptions
{
    ...
    /// omitted resolves the current executable (the dsh CLI when hosted in a dsh surface).</summary>
    public string? DshBin { get; set; }
    ...
    /// <summary>Working directory for the dsh process itself.</summary>
