...
/// machine: every process sharing one <c>$DSH_HOME</c> reports the same id, and deleting the file
...
public interface IIdentityService
{
    ...
    /// <summary>The resolved harness home this identity is scoped to (<c>$DSH_HOME</c> or the default <c>~/.dsh</c>).</summary>
    string Home { get; }
}
