...
/// locale middleware (<see cref="HshWebApp"/>), and carried into the interactive circuit through
...
public sealed class WebLocale
{
    ...
    /// <summary>HttpContext.Items key carrying the negotiated locale id (see <see cref="HshWebApp"/>).</summary>
    public const string ItemsKey = "hsh.locale";

    /// <summary>PersistentComponentState key carrying the pinned locale across prerender and circuit.</summary>
    public const string StateKey = "hsh-locale";
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishStrings = new Dictionary<string, string>
    {
        ...
        ["messagePlaceholder"] = "Message hsh...",
        ["send"] = "Send",
        ["running"] = "running",
        ["queued"] = "queued",
