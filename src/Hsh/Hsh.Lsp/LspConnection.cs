...
/// redirected, scrubs the ambient HSH_* environment before the spec's entries merge, retains a bounded
...
internal sealed class LspProcessHandle : ILspProcessHandle
{
    ...
    /// <summary>Scrub the ambient HSH_* facts, then merge the spec's explicit entries (null tombstones remove).</summary>
