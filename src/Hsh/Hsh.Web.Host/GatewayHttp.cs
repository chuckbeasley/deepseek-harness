...
public static class GatewayHttp
{
    ...
    public static void MapGateway(this WebApplication app, HshRpcRegistry registry)
    {
    ...
    private static async Task HandleAsync(HttpContext http, HshRpcRegistry registry, string ns, string method)
    {
