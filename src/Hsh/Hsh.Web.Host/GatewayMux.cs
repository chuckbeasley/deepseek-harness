...
public static class GatewayMux
{
    ...
    public static void MapMux(this WebApplication app, HshRpcRegistry registry, Context ctx)
    {
    ...
    private static async Task RunConnectionAsync(WebSocket socket, HshRpcRegistry registry, Context ctx)
    {
    ...
    private static async Task RunStreamAsync(
        ...
        MuxWriter writer, HshRpcRegistry registry, Context ctx, CancellationTokenSource streamCts)
    {
        try
        {
    ...
    private static async Task RunEventStreamAsync(string streamId, MuxWriter writer, Context ctx, CancellationToken ct)
    {
        ...
        var home = Environment.GetEnvironmentVariable("HSH_HOME")
            ?? ctx.Get<string>("hshProfileDir")
