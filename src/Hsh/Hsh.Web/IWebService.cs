...
/// while keeping separate request and result types (port of <c>@deepseek-ai/hsh-web</c>).
/// </summary>
...
/// required, so selection never depends on registration order. Port of <c>@deepseek-ai/hsh-web</c>
/// WebRuntime.
/// </summary>
