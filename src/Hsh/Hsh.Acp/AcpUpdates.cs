...
/// <summary>
/// Standard ACP updates derived from committed HSH session events (port of the TS
...
public static class AcpUpdates
{
    ...
    /// <param name="evt">the committed HSH tool-call event.</param>
    ...
    /// <param name="evt">the committed HSH tool-result event.</param>
