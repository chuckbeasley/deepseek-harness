...
public sealed class HarnessClient : IDisposable, IAsyncDisposable
{
    ...
    /// <param name="options">hsh profile, patch, home, process, environment, and timeout options.</param>
    ...
    /// <summary>Original public hsh launch and timeout options for this client.</summary>
