...
public static class ToolCallScheduler
{
    ...
    /// a plain-text accepted result larger than $HSH_SNAPSHOT_SPILL_MAX_BYTES is spilled to the
    ...
    private static ToolExecutionResult ApplySpillPolicy(Harness.Agent.Agent agent, ToolCallBlock call, ToolExecutionResult result)
    {
        ...
        var envCap = Environment.GetEnvironmentVariable("HSH_SNAPSHOT_SPILL_MAX_BYTES");
