...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@deepseek-ai/hsh-workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@deepseek-ai/hsh-tool-workflow'
```
...
```sh
hsh plugin --profile <name> add @deepseek-ai/hsh-subagent-codex
hsh plugin --profile <name> add @deepseek-ai/hsh-subagent-claude-code
hsh plugin --profile <name> remove @deepseek-ai/hsh-subagent-codex
hsh plugin --profile <name> remove @deepseek-ai/hsh-subagent-claude-code
```
...
- id: tool-subagent-codex
  name: '@deepseek-ai/hsh-tool-subagent'
  disabled: true
  config:
    provider: codex
