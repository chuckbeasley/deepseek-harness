...
/// <summary>
/// End-to-end coverage: the real hsh CLI subprocess replays the recorded fixture through the
...
public static class EndToEndTests
{
    ...
    public static void TheHeadlessProfile_ReplaysTheRecordedStream()
    {
        ...
        try
        {
            ...
            Assert.Equal("@deepseek-ai/hsh-system-prompt", context.GetProperty("data").GetProperty("source").GetProperty("plugin").GetString(),
