...
{
    [Fact]
    public void Service_RegistersItselfAtItsKey()
    {
    ...
    [Fact]
    public async Task ContextDispose_UnregistersServiceAndRunsStopAsync()
    {
        var ctx = new Context();
        var service = new TestService(ctx, "alpha");
        Assert.True(ctx.Get<TestService>("alpha") is not null);
    ...
    [Fact]
    public void Set_SameInstanceTwice_IsANoOp()
    {
        using var ctx = new Context();
        var service = new TestService(ctx, "alpha");
    ...
    [Fact]
    public void Set_DifferentInstanceUnderExistingKey_Throws()
    {
        using var ctx = new Context();
    ...
    [Fact]
    public void Service_Dispose_StopsAndUnregisters()
    {
        using var ctx = new Context();
        var service = new TestService(ctx, "alpha");
    ...
    [Fact]
    public async Task Registry_TracksServiceKeysAndProvesDisposal()
    {
        var ctx = new Context();
        var service = new TestService(ctx, "alpha");
