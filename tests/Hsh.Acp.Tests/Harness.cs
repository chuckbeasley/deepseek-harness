...
internal sealed class Harness : IDisposable
{
    ...
    public static Harness Create(AcpHarnessOptions options)
    {
        ...
        var tempRoot = Path.Combine(Path.GetTempPath(), "hsh-acp-tests-" + Guid.NewGuid().ToString("N"));
...
/// <summary>The built hsh CLI entry and per-test runtime resolution (the profile e2e).</summary>
