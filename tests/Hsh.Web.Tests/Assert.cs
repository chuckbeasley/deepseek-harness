...
public static class Assert
{
    ...
    /// <summary>Asserts <paramref name="value"/> is not null and returns it.</summary>
    ...
    /// <summary>Asserts the async <paramref name="action"/> throws <typeparamref name="TException"/> or a derived type, and returns it.</summary>
