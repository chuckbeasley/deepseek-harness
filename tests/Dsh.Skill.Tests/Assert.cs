...
/// <summary>Minimal zero-dependency assertion helpers for the Phase 4 console test runner.</summary>
public static class Assert
{
    ...
    {
        if (DeepEqual(expected, actual)) Fail(message ?? $"expected something other than {expected}");
    }
    ...
    /// <summary>Asserts <paramref name="action"/> throws <typeparamref name="TException"/> asynchronously and returns it.</summary>
