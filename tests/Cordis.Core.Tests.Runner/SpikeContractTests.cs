...
/// </summary>
internal static class SpikeContractTests
{
    public static async Task SpikeSection7_Surface_CompilesAndRuns()
    {
    ...
    public static void On_AcceptsLambdaWithExplicitParameterTypes()
    {
