...
{
    public static void Emit_CallsListenersInRegistrationOrder()
    {
    ...
    public static void Emit_DeliversPayloadToTypedListener()
    {
        using var ctx = new Context();
        string? seen = null;
    ...
    public static void Emit_ThrowingListener_PropagatesAndAbortsRemaining()
    {
        using var ctx = new Context();
        var reached = false;
    ...
    public static async Task Parallel_AwaitsEveryListenerAndAggregatesFailures()
    {
        using var ctx = new Context();
        var ran = 0;
    ...
    public static async Task Serial_AwaitsInOrderAndReturnsFirstBailValue()
    {
        using var ctx = new Context();
        var order = new List<string>();
    ...
    public static void Bail_StopsAtFirstBailValue()
    {
        using var ctx = new Context();
        var order = new List<string>();
    ...
    public static void Waterfall_ShortCircuit_ReturnsListenerValueWithoutCallingNext()
    {
        using var ctx = new Context();
    ...
    public static void Waterfall_NextReturns_PropagateThroughTheChain()
    {
        using var ctx = new Context();
    ...
    public static void Waterfall_Veto_StopsDownstreamTransformers()
    {
        using var ctx = new Context();
    ...
    public static void Waterfall_DeliversEventArgumentsToListeners()
    {
        using var ctx = new Context();
    ...
    public static void Once_RemovesListenerAfterFirstInvocation()
    {
        using var ctx = new Context();
        var count = 0;
    ...
    public static void On_DisposerRemovesTheRegistration()
    {
        using var ctx = new Context();
        var count = 0;
    ...
    public static void Prepend_AddsListenerBeforeExisting()
    {
        using var ctx = new Context();
        var order = new List<string>();
