...
public static class UiCompositionTests
{
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "hsh-ui-composition-" + Guid.NewGuid().ToString("N"));
        ...
        try
        {
            ...
            Assert.True(body.Contains("hsh-brand-row", StringComparison.Ordinal), "the sidebar brand row renders");
            ...
            Assert.True(body.Contains("hsh-session-list", StringComparison.Ordinal), "the session-list contribution renders");
            Assert.True(body.Contains("class=\"hsh-input-row\"", StringComparison.Ordinal), "the composer contribution renders");
            ...
            Assert.True(settingsBody.Contains("hsh-page", StringComparison.Ordinal), "the settings page renders its shell");
            ...
            Assert.True(planBody.Contains("hsh-page", StringComparison.Ordinal), "the plan page renders its shell");
